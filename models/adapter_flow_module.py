...
from models.flow_model_with_adapter2 import FlowModel
...
class FlowModule(LightningModule):
    ...
    def __init__(self, cfg):
        ...
        self._exp_cfg = cfg.experiment ## trainging_mode: str = "full"; from_scratch: bool = False
        ...
        # ckpt = torch.load(self._model_cfg.weights,map_location='cuda:1')["state_dict"]
        # new_state_dict = {}
        ...
        # for b in range(self.model._ipa_conf.num_blocks):
            
        #     for param in self.model.trunk[f'adapter_{b}'].parameters():
        #         param.requires_grad = True
        
        # for param in self.model.mol_net.parameters():
        #     param.requires_grad = True        
        ...
        config = LoraConfig(
            r=self._model_cfg.lora_r,
            lora_alpha=self._model_cfg.lora_alpha,
            target_modules=self._model_cfg.lora_target_modules,
            lora_dropout=self._model_cfg.lora_dropout,
            bias=self._model_cfg.lora_bias
        )
        # import pdb;pdb.set_trace()
    ...
    def predict_step(self, batch, batch_idx):
        ...
        atom37_traj, model_traj, _ = interpolant.sample(
            num_batch, sample_length, self.model,substrate,substrate_mask,
