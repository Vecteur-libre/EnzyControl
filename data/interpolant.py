...
class Interpolant:
    ...
    def igso3(self):
        '''
        sampling rotations from igso3 distribution
        '''
    ...
    def _corrupt_trans(self, trans_1, t, res_mask, diffuse_mask):
        ...
        ### only diffuse trans which are 1 index in the diffuse_mask
    ...
    def corrupt_batch(self, batch):
        ...
        '''
        so3_t  rotmats_t   rotmats_t.shape=[B,N,3,3]
        r3_t   trans_t     trans_t.shape=[B,N,3]
